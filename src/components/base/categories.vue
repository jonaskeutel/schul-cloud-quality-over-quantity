    ...
    <md-card>
      ...
      <md-card-actions>
        <template v-if="review">
            <md-button v-on:click="$emit('categories-accepted')">Akzeptieren</md-button>
            <md-button disabled v-on:click="visibleDialog = 'proposal'" class="md-accent">Änderungen vorschlagen</md-button>
        </template>
        <template v-else>
            <md-button v-on:click="$emit('categories-set')">Weiter</md-button>
        </template>
